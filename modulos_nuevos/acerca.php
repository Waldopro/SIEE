    ...
    <div class="container">
        <div class="content">
            ...
            <section class="achievements">
                <h2>Logros</h2>
                <ul>
                    <li>Implementación exitosa del sistema de gestión de usuarios.</li>
                    <li>Desarrollo de un módulo de control de inventarios.</li>
                    <li>Generación de reportes personalizados para la administración.</li>
                </ul>
            </section>
